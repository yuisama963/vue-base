 ...
 * @LastEditTime: 2022-08-31 20:07:20
...
<template>
  ...
  >
    ...
    <set-role :roleList="roleList" :selectedRoleList="selectedRoleList" @onReload="getAllRoleList" @onCloseAllDrawer="onCloseAllDrawer"></set-role>
  </a-drawer>
</template>
