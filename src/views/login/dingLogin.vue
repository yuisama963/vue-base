 ...
 * @LastEditTime: 2022-09-02 20:49:54
...
const openDing = () => {
  ...
  window.location = `dingtalk://dingtalkclient/action/openapp?corpid=ding5ea649d660e6e6934ac5d6980864d335&container_type=work_platform&app_id=0_1764414482&redirect_type=jump&redirect_url=${url}`
}
</script>
